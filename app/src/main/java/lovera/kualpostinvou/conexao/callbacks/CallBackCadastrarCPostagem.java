...
public class CallBackCadastrarCPostagem implements Callback<ResponseBody>{

    private final MsgFromConexaoModelo msg;
    private final ConteudoPostagem conteudo;

    public CallBackCadastrarCPostagem(MsgFromConexaoModelo msg, ConteudoPostagem conteudo) {
        this.msg = msg;
    ...
    public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
        if(response.isSuccessful()){
            ...
            this.msg.passarCodConteudoPostagem(this.conteudo);
        }
        else{
            //TODO
        }
